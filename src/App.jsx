...
import { Menu, X, Map, Home, Compass, Clock, User, Settings, LogOut } from 'lucide-react';
              ...
              {isLoggedIn ? (
                <div className="relative group">
                  ...
                  <div className="absolute right-0 mt-2 w-48 bg-white rounded-md shadow-lg overflow-hidden z-10 hidden group-hover:block">
                    ...
                    <Link to="/trips" className="block px-4 py-2 text-gray-800 hover:bg-gray-100">
                      My Trips
                    </Link>
                    <button 
                      onClick={logout}
          ...
          <div className="md:hidden bg-white">
            <div className="container mx-auto px-4 py-3 space-y-3">
              ...
              <div className="pt-2 border-t border-gray-100 flex flex-col space-y-2">
                {isLoggedIn ? (
                  <>
                    <Link to="/profile" className="flex items-center px-4 py-2 text-gray-600 hover:text-gray-900 text-left" onClick={toggleMenu}>
                    ...
                    <button 
                      ...
                      className="flex items-center px-4 py-2 text-red-600 hover:text-red-700 text-left"
                    >
                      <LogOut size={16} className="mr-2" />
                      Sign Out
                    </button>
                  ...
                  <>
                    <Link to="/login" className="px-4 py-2 text-gray-600 hover:text-gray-900 text-left" onClick={toggleMenu}>
                      Sign In
                    </Link>
                    <Link to="/signup" className="px-4 py-2 bg-blue-600 text-white rounded-md hover:bg-blue-700 text-left" onClick={toggleMenu}>
                      Sign Up
                    </Link>
                  </>
                )}
